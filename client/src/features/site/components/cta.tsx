...
export function CtaSection() {
  return (
    <section className="border-line relative w-full overflow-hidden border-t-4 bg-purple-50 px-6 pt-8 pb-0 sm:px-10 sm:pt-10 md:px-16 lg:h-[480px] lg:px-[220px] lg:pt-[4px] lg:pb-[4px]">
